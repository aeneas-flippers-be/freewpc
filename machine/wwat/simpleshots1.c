...
//-ALLSET_ENTRY (waitplunge, sw_rapids_main_ramp, sw_rapids_enter, sw_canyon_entrance, sw_bigfoot_cave, sw_canyon_main, sw_right_inlane)
CALLSET_ENTRY (waitplunge, any_pf_switch)
{
